...
public class ControladorPeliculas {
	...
	public ModelAndView insertarPelicula( @Valid final Pelicula pelicula, BindingResult br, @ModelAttribute Pelicula peliculaItem, HttpServletRequest request ) {
		try {
	...
	public GestorPelicula getGestorPeliculas() {
		return gestorPeliculas;
	}

	public void setGestorPeliculas(GestorPelicula gestorPeliculas) {
